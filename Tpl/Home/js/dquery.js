...
dquery.methods = {
    ...
    sameDate: function(cmp) {
        return this.getDate() == cmp.getDate() && this.getMonth() == cmp.getMonth() && this.getFullYear() == cmp.getFullYear();
    },
...
(function() {
    ...
    var parseFunctions = dquery.map(formats, function(format) {
        ...
        return function(str) {
            ...
            if (!(match = regex.exec(str))) return undefined;
